<template>
  <BaseLayout>
    <div v-if="loaded">
      <h2 v-if="teamsCount > 0">{{ teamsCount }} csapat vett részt</h2>
      <h2 v-else>Nem található felvett csapat</h2>
      <div class="flex">
    ...
    <div role="status" class="mt-10" v-else>
...
export default {
  ...
  computed: {
    teamsCount(){
      return this.eurocup.teams.length
    }
  },  
  components: {
    BaseLayout,
